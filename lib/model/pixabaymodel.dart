...
PixabayModel PixabayModelFromJson(String str) =>
    PixabayModel.fromJson(json.decode(str));
String PixabayModelToJson(PixabayModel data) =>
...
class PixabayModel {
  ...
  PixabayModel({this.total, this.totalHits, this.hits});

  PixabayModel.fromJson(Map<String, dynamic> json) {
    total = json['total'];
